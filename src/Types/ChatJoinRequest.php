 ...
 */
final class ChatJoinRequest extends TelegramObject
{
   ...
   * @param null|list<MessageEntity> $captionEntities
   */
  public function answerAnimationPm(
    InputFile|string $animation,
    ?string $businessConnectionId = null,
    ?int $messageThreadId = null,
    ?int $directMessagesTopicId = null,
   ...
   * @param null|list<MessageEntity> $captionEntities
   */
  public function answerDocumentPm(
    InputFile|string $document,
    ?string $businessConnectionId = null,
    ?int $messageThreadId = null,
    ?int $directMessagesTopicId = null,
   ...
   * @param null|list<int> $suggestedTipAmounts
   */
  public function answerInvoicePm(
    string $title,
    string $description,
    string $payload,
    string $currency,
   ...
   * @param list<InputMediaAudio|InputMediaDocument|InputMediaLivePhoto|InputMediaPhoto|InputMediaVideo> $media
   */
  public function answerMediaGroupPm(
    array $media,
    ?string $businessConnectionId = null,
    ?int $messageThreadId = null,
    ?int $directMessagesTopicId = null,
