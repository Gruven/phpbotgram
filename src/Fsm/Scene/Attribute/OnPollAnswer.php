 ...
 *
 * Mirrors `on.poll_answer` from `OnMarker` (`aiogram/fsm/scene.py:973`).
 */
#[Attribute(Attribute::TARGET_METHOD | Attribute::IS_REPEATABLE)]
final readonly class OnPollAnswer extends OnAttribute
{
  public function __construct(
    ...
    parent::__construct('poll_answer', $action, $after, ...$filters);
  }
}
