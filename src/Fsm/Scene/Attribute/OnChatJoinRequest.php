 ...
 *
 * Mirrors `on.chat_join_request` from `OnMarker` (`aiogram/fsm/scene.py:976`).
 */
#[Attribute(Attribute::TARGET_METHOD | Attribute::IS_REPEATABLE)]
final readonly class OnChatJoinRequest extends OnAttribute
{
  public function __construct(
    ...
    parent::__construct('chat_join_request', $action, $after, ...$filters);
  }
}
