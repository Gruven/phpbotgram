 ...
 *
 * Mirrors `on.edited_message` from `OnMarker` (`aiogram/fsm/scene.py:976`).
 */
#[Attribute(Attribute::TARGET_METHOD | Attribute::IS_REPEATABLE)]
final readonly class OnEditedMessage extends OnAttribute
{
  public function __construct(
    ...
    parent::__construct('edited_message', $action, $after, ...$filters);
  }
}
