 ...
 *
 * Mirrors `on.shipping_query` from `OnMarker` (`aiogram/fsm/scene.py:970`).
 */
#[Attribute(Attribute::TARGET_METHOD | Attribute::IS_REPEATABLE)]
final readonly class OnShippingQuery extends OnAttribute
{
  public function __construct(
    ...
    parent::__construct('shipping_query', $action, $after, ...$filters);
  }
}
