 ...
 *
 * Mirrors `on.my_chat_member` from `OnMarker` (`aiogram/fsm/scene.py:974`).
 */
#[Attribute(Attribute::TARGET_METHOD | Attribute::IS_REPEATABLE)]
final readonly class OnMyChatMember extends OnAttribute
{
  public function __construct(
    ...
    parent::__construct('my_chat_member', $action, $after, ...$filters);
  }
}
