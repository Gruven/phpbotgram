 ...
 *
 * Mirrors `on.pre_checkout_query` from `OnMarker` (`aiogram/fsm/scene.py:971`).
 */
#[Attribute(Attribute::TARGET_METHOD | Attribute::IS_REPEATABLE)]
final readonly class OnPreCheckoutQuery extends OnAttribute
{
  public function __construct(
    ...
    parent::__construct('pre_checkout_query', $action, $after, ...$filters);
  }
}
