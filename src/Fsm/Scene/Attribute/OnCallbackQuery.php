 ...
 *
 * Mirrors `on.callback_query` from `OnMarker` (`aiogram/fsm/scene.py:969`).
 */
#[Attribute(Attribute::TARGET_METHOD | Attribute::IS_REPEATABLE)]
final readonly class OnCallbackQuery extends OnAttribute
{
  public function __construct(
    ...
    parent::__construct('callback_query', $action, $after, ...$filters);
  }
}
